<style>
    body.detail-page {
        ...
        background: radial-gradient(circle at top left, rgba(245, 176, 65, .08), transparent 34rem), #080a0b;
        color: #f6f2e9;
    }
    ...
    .rd-hero {
        ...
        border-bottom: 1px solid rgba(245, 176, 65, .24);
        overflow: hidden;
    }
    ...
    .rd-hero::before {
        ...
        position: absolute;
        inset: 0;
        background: linear-gradient(90deg, rgba(8, 10, 11, .98), rgba(8, 10, 11, .58), rgba(8, 10, 11, .86)), linear-gradient(180deg, rgba(8, 10, 11, .1), #080a0b 96%);
    }
    ...
    .rd-status.open {
        color: #43e68b;
        border-color: rgba(67, 230, 139, .35);
    }
    ...
    .rd-similar-item {
        ...
        color: inherit;
        text-decoration: none;
        border: 1px solid rgba(245, 176, 65, .16);
        border-radius: 8px;
        padding: .55rem;
        background: rgba(255, 255, 255, .055);
    }
    ...
    .rd-map {
        ...
        background: linear-gradient(35deg, rgba(111, 168, 220, .55), transparent 34%), linear-gradient(135deg, #dceee7 0%, #edf2e7 48%, #cbdff1 100%);
    }
