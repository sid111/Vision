                    ...
                    <?php while ($cafe = $result->fetch_assoc()): ?>
                        <div class="col-md-6 col-xl-4">
                            <div class="glass-card place-card">
                                <div class="restaurant-image" style="background-image: url('<?php echo !empty($cafe['image']) ? htmlspecialchars($cafe['image']) : 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=1200'; ?>'); background-size: cover; background-position: center;">
                                </div>
                                <div class="p-3">
